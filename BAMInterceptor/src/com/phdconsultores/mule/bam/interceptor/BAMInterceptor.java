...

{
    ...
    protected void initDataPublisher() {
        ...
        String streamDefinition = "{  'name':'book_order_details',  'version':'1.0.0',  'nickName': 'Order details',  'description': 'Stream for sending captured events when ordering books.',  'metaData':[          {'name':'publisherIP','type':'STRING'}  ],  'payloadData':[          {'name':'id','type':'LONG'},          {'name':'title','type':'STRING'},          {'name':'author','type':'STRING'},          {'name':'price','type':'DOUBLE'},          {'name':'quantity','type':'INT'},          {'name':'address','type':'STRING'},          {'name':'email','type':'STRING'}  ]}";
