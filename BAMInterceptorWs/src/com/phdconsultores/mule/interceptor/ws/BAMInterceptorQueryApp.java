...
public class BAMInterceptorQueryApp extends AbstractInterceptingMessageProcessor implements Interceptor{
    private static Log log = LogFactory.getLog(BAMInterceptorQueryApp.class);
    ...
    private static final int ID_SERVICIO = 9;
    private static final String SERVICIO = "QueryApp";
    private static final int QUANTITY = 1;

    public BAMInterceptorQueryApp() throws Exception {
