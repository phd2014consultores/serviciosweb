...
public class BAMInterceptorAnularEjecucion extends AbstractInterceptingMessageProcessor implements Interceptor{
    private static Log log = LogFactory.getLog(BAMInterceptorAnularEjecucion.class);
    ...
    private static final String SERVICIO = "AnularEjecucion";
    private static final int QUANTITY = 1;

    public BAMInterceptorAnularEjecucion() throws Exception {
