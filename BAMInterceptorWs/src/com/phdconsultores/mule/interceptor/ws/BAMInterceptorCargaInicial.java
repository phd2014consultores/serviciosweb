...
public class BAMInterceptorCargaInicial extends AbstractInterceptingMessageProcessor implements Interceptor{
    private static Log log = LogFactory.getLog(BAMInterceptorCargaInicial.class);
    ...
    private static final int ID_SERVICIO = 2;
    private static final String SERVICIO = "CargaInicial";
    private static final int QUANTITY = 1;

    public BAMInterceptorCargaInicial() throws Exception {
