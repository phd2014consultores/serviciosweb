...
public class BAMInterceptorMediacionEtl extends AbstractInterceptingMessageProcessor implements Interceptor{
    private static Log log = LogFactory.getLog(BAMInterceptorMediacionEtl.class);
    ...
    private static final int ID_SERVICIO = 8;
    private static final String SERVICIO = "MediacionEtl";
    private static final int QUANTITY = 1;

    public BAMInterceptorMediacionEtl() throws Exception {
