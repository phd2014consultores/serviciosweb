...
public class BAMInterceptorMediacion extends AbstractInterceptingMessageProcessor implements Interceptor{
    private static Log log = LogFactory.getLog(BAMInterceptorMediacion.class);
    ...
    private static final int ID_SERVICIO = 7;
    private static final String SERVICIO = "Mediacion";
    private static final int QUANTITY = 1;

    public BAMInterceptorMediacion() throws Exception {
