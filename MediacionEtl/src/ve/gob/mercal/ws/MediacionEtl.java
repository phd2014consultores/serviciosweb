...
@WebService(name = "MediacionEtl", targetNamespace = "http://ws.mercal.gob.ve/")
public interface MediacionEtl {
	...
	@WebMethod(operationName = "mediacionetl", action = "urn:MediacionEtl")
	public int mediacionetl(
			...
			@WebParam(name = "transformaciones") @XmlElement(name = "transformaciones",required=true, nillable=false) String transformaciones,
			...
			@WebParam(name = "timestampIni" ) @XmlElement(name = "timestampIni",required=true, nillable=false) String timestampIni,
			@WebParam(name = "timestampFin" ) @XmlElement(name = "timestampFin",required=true, nillable=false) String timestampFin,
