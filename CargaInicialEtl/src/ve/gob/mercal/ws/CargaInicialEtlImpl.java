...
/**
 * Clase que implementa el servicio de cargainicialetl que ejecuta un Kettle Job de Pentaho Data Integration, 
...
@WebService(targetNamespace = "http://ws.mercal.gob.ve/", endpointInterface = "ve.gob.mercal.ws.CargaInicialEtl",
portName = "CargaInicialEtlPort", serviceName = "CargaInicialEtl")
@BindingType(javax.xml.ws.soap.SOAPBinding.SOAP12HTTP_BINDING)
public class CargaInicialEtlImpl implements CargaInicialEtl {
	
	public CargaInicialEtlImpl(){}
	...
	public int cargainicialetl(
        ...
        dirLogs = dirLogs + "/" + usuarioBDOracle + "_CINI_ETL_" + new SimpleDateFormat("yyyy-MM-dd").format(fechaHoy) + "_" + new SimpleDateFormat("HH:mm:ss.SSS").format(fechaHoy);
        String filename =  usuarioBDOracle + "_CINI_ETL_" + new SimpleDateFormat("yyyy-MM-dd").format(fechaHoy) + "_" + new SimpleDateFormat("HH:mm:ss").format(fechaHoy);
